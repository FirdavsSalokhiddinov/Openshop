...
const EmptyCart = () => {
    return(
        <div className="EmptyCart" style={{display:'flex',width: '100%',justifyContent:"center",alignItems:"center",}}>
                    ...
                    <div className="cartEmpty" style={{width:'100%',display:'flex',justifyContent:'center',alignItems:'center',}}>
                        <div className="cartEmptyText" style={{
                            ...
                            <div className="shop" style={{
                                ...
                                <Button variant="primary" type="submit" style={{width: '180px', height: '45px', borderRadius:"25px", background:"#1E90FF"}}>
                                    Sign in
                                </Button>
